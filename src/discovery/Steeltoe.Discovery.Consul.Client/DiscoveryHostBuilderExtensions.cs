...
namespace Steeltoe.Discovery.Consul.Client
{
    ...
    {
        public static IWebHostBuilder UseDiscoveryClient(this IWebHostBuilder builder)
        {
            return builder
                .ConfigureServices((context, services) =>
                {
                    services.PostConfigure<ConsulDiscoveryOptions>(options =>
                    {
                        ...
                        var urls = context.Configuration["urls"]?.Split(new[] { ';' }, StringSplitOptions.RemoveEmptyEntries);

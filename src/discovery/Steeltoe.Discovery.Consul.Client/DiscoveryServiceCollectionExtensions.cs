...
namespace Steeltoe.Discovery.Consul.Client
{
    ...
    {
        public static IServiceCollection AddConsulDiscoveryClient(this IServiceCollection services, IConfiguration configuration, IDiscoveryLifecycle lifecycle = null)
        {
